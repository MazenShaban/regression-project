...
#plot(model)
#######################################################################################
#Independent_Variables <- numeric_ObesityDataSet$N_MTRANS +
 # numeric_ObesityDataSet$N_CALC + numeric_ObesityDataSet$TUE + numeric_ObesityDataSet$FAF +
  #numeric_ObesityDataSet$N_SCC + numeric_ObesityDataSet$N_CAEC + numeric_ObesityDataSet$CH2O +
  #numeric_ObesityDataSet$N_SMOKE + numeric_ObesityDataSet$NCP + numeric_ObesityDataSet$FCVC +
  #numeric_ObesityDataSet$N_FAVC + numeric_ObesityDataSet$N_family_history_with_overweight +
  #numeric_ObesityDataSet$Weight +  numeric_ObesityDataSet$Height + 
  #numeric_ObesityDataSet$Age + numeric_ObesityDataSet$N_Gender

#Y_hat <- predict(model)

# Scatter Plot representing the observed and predicted values
#plot(Independent_Variables, Y_hat, col = 'blue', xlab = 'X', ylab = 'Y')

# Adding regression line to the scatter plot
#abline(lm(Y_hat ~ Independent_Variables), col = "red", lwd = 2)
...
# Doing partial F-test to compare between the two models according to hypotheses.
